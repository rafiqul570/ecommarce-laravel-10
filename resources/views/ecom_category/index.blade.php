...
<body>
    ...
    <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
      <div class="d-flex justify-content-between">
        ...
        <h5><a  href="{{route('ecom_category.create')}}" class="btn btn-info text-light">Add Category</a></h5>
      </div>
           ...
           <table id="datatable1" class="table table-striped table-info">
             ...
             <tbody>
               ...
               <tr>
                 ...
                 <td>
                    <a href="{{route('ecom_category.edit', $data->id)}}">Edit</a> ||
                    <a onclick="return confirm('Are you sure ?')" href="{{route('ecom_category.delete', $data->id)}}">Delete</a>
                 </td>
               </tr>
               @endforeach
             </tbody>
